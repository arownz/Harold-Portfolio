...
const techStacks = ref<Record<string, TechItem[]>>({
  ...
  mobile: [
    ...
    { name: "React Native", icon: "react-native-logo-884x1024.webp", description: "Builds native iOS and Android apps using React's component model and the full JavaScript ecosystem." },
  ...
  database: [
    ...
    { name: "MySQL Workbench / MySQL", icon: "OSAAS.webp", description: "Industry-standard relational DBMS with a visual workbench for schema design, query optimization, and data modeling." },
    { name: "XAMPP / MariaDB", icon: "xamppicon.webp", description: "Local development stack combining Apache, MariaDB, and PHP — ideal for offline full-stack backend development." },
  ],
  cloud: [
    ...
    { name: "Microsoft Azure", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azure/azure-original.svg", description: "Microsoft's cloud ecosystem for hosting, serverless computing, and enterprise-grade services with global reach." },
    { name: "Netlify", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/netlify/netlify-original.svg", description: "Frontend deployment platform for continuous delivery, serverless functions, and preview builds for static and modern web apps." },
    { name: "Vercel", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vercel/vercel-original.svg", description: "Deployment platform optimized for frontend frameworks, edge delivery, and fast preview deployments with Git-based workflows." },
  ...
  devtools: [
    ...
    { name: "Github Desktop", icon: "githubdesk.webp", description: "GUI client that streamlines commit, branch management, and pull request workflows without needing the command line." },
  ...
  networking: [
    ...
    { name: "Wireshark", icon: "wiresharkicon.webp", description: "Network protocol analyzer for capturing and inspecting live packet traffic for security analysis and debugging." },
  ],
  virtualization: [
  ...
  ai: [
    ...
    { name: "Claude", icon: "claudeicon.webp", description: "Anthropic's AI focused on safety and nuanced reasoning — used extensively throughout this portfolio's development." },
